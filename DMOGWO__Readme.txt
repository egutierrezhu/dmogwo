...
This code is a discrete version to Multi-Objective Grey Wolf Optimizer (MOGWO) for millimeter wave vehicular communications. First, all possible input settings and their objective functions are contained in a file (tabela3.csv), as described below:
Discrete parameters:
...
In order to minimize f1, f2 and f3 should be executed the main code “DMOGWO.m”. After that, the results are saved in the folder “ws_vanets/GWXXgYY”. Where, XX is the number of grey wolves, and YY is the maximum number of generations. From these results we can generate figures and metrics such as:
